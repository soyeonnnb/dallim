...
export const planetData: PlanetType[] = [
  {
    ...
    watch: require('@/assets/images/planets/watch/WatchBlack.gif'),
  ...
  },
  {
    ...
    watch: require('@/assets/images/planets/watch/WatchYellow.gif'),
    Rotate: require('@/assets/images/planets/rotate/RotateYellow.gif'), // check
  },
  {
    ...
    watch: require('@/assets/images/planets/watch/WatchBlue.gif'),
    Rotate: require('@/assets/images/planets/rotate/RotateBlue.gif'), // check
  },
  {
    ...
    watch: require('@/assets/images/planets/watch/WatchPurple.gif'),
    Rotate: require('@/assets/images/planets/rotate/RotatePurple.gif'), // check
  },
  {
    ...
    watch: require('@/assets/images/planets/watch/WatchRed.gif'),
    Rotate: require('@/assets/images/planets/rotate/RotateRed.gif'), // check
  },
];
